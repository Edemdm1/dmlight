...
const contacts = {
    ...
    callCenter: {
        icon: "fas fa-globe-phone",
        phone: "+038 123 345 6789",
        info() {
            return `
            <li class="mb-2"><a href="tel:${this.phone}"><i class="${this.icon}"</i>"><span>${this.phone}: This number is toll free if callling from ${contacts.address.country}, otherwise we advise You to use the electronic form of communication. </span></a></li>
            `
        }
    },
    ...
    support: {
        ...
        info() {
            return `
            <li class="mb-2"><a href="mailto:${this.email}"><i class="${this.icon}"</i>"><span> Please feel free to write on email to  ${this.email}, or to use our electronic tcketing system. </span></a></li>
            `
        }
    }
};
...
console.dir(contacts.address.info());
console.dir(contacts.support.info());
console.dir(contacts.callCenter.info());
